...
// URI → (type, slug). Phase 1 only the homepage maps to the profile (the CV). Posts/articles land in
// Phase 2/3; until then everything else is passthrough (humans + bots get the SPA shell).
function route(uri) {
